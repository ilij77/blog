                        ...
                        <form role="form" method="post" action="{{ route('posts.update',['post'=>$post->id]) }}"enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category_id @error('category_id') is-invalid @enderror" name="category_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div><img src="{{$post->getImage()}}"  alt="" class="img-thumbnail mt-2" width="200pt"></div>
                                </div>
